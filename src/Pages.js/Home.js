  ...
  return (
    <>
      ...
      <div className="flex flex-col flex-wrap text-center pt-[70px]">
        ...
        <h1 className="text-transparent bg-clip-text bg-gradient-to-r  from-red-600 to-green-300 text-[75px] max-sm:text-[35px] font-bold text-orange-500 fill-orange-500">
