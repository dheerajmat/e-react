...
function Man() {
  const menShoes = shoesData.filter((shoe) => shoe.category === "Men's s");
  return (
    <>
      ...
      <h1 className="text-[40px] text-center pt-3 font-bold "> <span className="text-blue-600">Man</span> Footwares</h1>
